...
const middelsteGetallen = getallen.filter(getal => getal > 10 && getal < 20); /* jouw code hier */
...
const langeAwoorden = woorden.filter(woord => woord.startsWith ('a') && woord.length > 5); /* jouw code hier */
console.log('Lange woorden met a:', langeAwoorden);

// TODO: Filter even getallen die groter zijn dan 15
const groteEvenGetallen = getallen.map(getal => getal > 15 && getal % 2 === 0); /* jouw code hier */
