...
const gesorteerdeScores =scores.sort((a, b) => a - b); /* jouw code hier */
console.log('Scores laag naar hoog:', gesorteerdeScores);

// TODO: Sorteer scores van hoog naar laag  
const scoresHoogNaarLaag = scores.sort((a, b) => b - a); /* jouw code hier */
console.log('Scores hoog naar laag:', scoresHoogNaarLaag);

// TODO: Sorteer steden alfabetisch
const gesorteerdeSteden = steden.slice().sort(); /* jouw code hier */
